...
public boolean saveOrUpdate(StockPrice stock)throws StockValidationExcepion {
	   Set<ConstraintViolation<StockPrice>> constraintViolations =
           validator.getValidator().validate(stock);
...
//		   throw new DelistedException("ERR");
//	   }
       //assertEquals(1, constraintViolations.size());if (stock.getSymbol().equals("ERR")) {
